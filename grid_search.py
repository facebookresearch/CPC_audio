...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="A stool-like slurm-compatible grid search tool")
    ...
    parser.add_argument("--name", type=str, default=None, help="sbatch name of job. Also used as the output directory")
    ...
    root_dir = (pathlib.PosixPath('~/cpc') / args.name / time.strftime("%Y_%m_%d_%H_%M_%S")).expanduser()
